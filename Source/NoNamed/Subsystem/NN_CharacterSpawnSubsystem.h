...
public:
	...
	ANN_CharacterBase* SpawnCharacterFromObject(UNN_CharacterObjectBase* CharacterObject, UWorld* World, const FTransform& SpawnTransform, const FNN_CharacterSpawnContext& SpawnContext);
};
